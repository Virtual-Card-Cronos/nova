/**
 * Admin Panel Page
 * Shows gift card orders being processed through Crypto.com testnet
 * Only accessible to the first user who logs in (admin)
 */
...
export default function AdminPage() {
  ...
  // Check admin status and load transactions
  useEffect(() => {
    if (account) {
      const adminStatus = isAdmin(account.address)
      ...
      <div className="min-h-screen bg-background-dark">
        ...
        <main className="max-w-[1200px] mx-auto px-6 py-20">
          <div className="text-center">
            <div className="mb-6 inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary-user/10">
              <span className="material-symbols-outlined text-4xl text-primary-user">admin_panel_settings</span>
            </div>
            <h1 className="text-3xl font-bold text-white mb-4">Admin Panel Access</h1>
            <p className="text-slate-400 mb-8 max-w-md mx-auto">
              Connect your wallet to access the admin panel. Only the first user to connect becomes the admin.
            </p>
            <ConnectWallet />
          </div>
        </main>
      ...
      <div className="min-h-screen bg-background-dark">
        ...
        <main className="max-w-[1200px] mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-slate-400 mb-8 max-w-md mx-auto">
              You are not authorized to access the admin panel. Only the first user to log in has admin privileges.
            </p>
            <button
              onClick={() => router.push('/')}
              className="bg-primary-user hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-bold transition-all"
            >
              Go to Store
            </button>
          </div>
    ...
    <div className="min-h-screen bg-background-dark">
      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          ...
          <div className="bg-card-dark rounded-xl p-4 border border-white/5">
            <div className="flex items-center gap-2 mb-2">
              <span className="material-symbols-outlined text-yellow-500 text-lg">hourglass_top</span>
          ...
          <div className="bg-card-dark rounded-xl p-4 border border-white/5">
            <div className="flex items-center gap-2 mb-2">
              <span className="material-symbols-outlined text-primary-user text-lg">attach_money</span>
